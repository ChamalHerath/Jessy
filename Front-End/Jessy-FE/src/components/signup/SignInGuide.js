...
const SignInGuide = ({navigation}) => {
  const [message, setMessage] = useState();
  const [messageType, setMessageType] = useState();

  //setting up the state for the dataset in teh signup screen
  ...
  // handle the password and the changes of the password input
  ...
  //   update the secure entry to the backend
  ...
  const handleAPIRequest = (credentials) => {
    axios
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.button}>
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate("SignUpGuide")}
            style={[
              styles.signIn,
              {
                borderColor: "#1f65b5",
